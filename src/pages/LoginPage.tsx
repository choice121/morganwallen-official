      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-cream/50 text-sm">
            {mode === 'login' ? 'Welcome back to the official fan hub.' : mode === 'signup' ? 'Join the Morgan Wallen fan community.' : 'Enter your email to receive a reset link.'}
          </p>
        </div>
              ...
              {resetSent ? (
                <div className="text-center py-4">
                  <p className="text-cream/70 text-sm leading-relaxed">
                    A password reset link was sent to <span className="text-gold-400">{email}</span>. Check your inbox.
                  </p>
                  <button
                    onClick={() => { setMode('login'); setResetSent(false) }}
